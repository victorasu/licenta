...
{
    public abstract class KartSpaceWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static KartSpaceWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(KartSpaceWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<KartSpaceDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<KartSpaceDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<KartSpaceDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<KartSpaceDbContext, Task<T>> func)
        {
            T result;
