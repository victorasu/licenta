...
namespace KartSpace.Migrations
{
    ...
    [Migration("20220605195543_Purchases_Added_CreationDate_StareComanda")]
    partial class Purchases_Added_CreationDate_StareComanda
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KartSpace.Events.Event", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("KartSpace.Purchases.Purchase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("KartSpace.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("KartSpace.Authorization.Users.User", null)
                        .WithMany("Claims")
